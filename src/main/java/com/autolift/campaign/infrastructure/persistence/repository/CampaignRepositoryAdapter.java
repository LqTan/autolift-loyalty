...
public class CampaignRepositoryAdapter implements CampaignRepository {
    ...
    public CampaignRepositoryAdapter(CampaignJpaRepository jpaRepository, CampaignPersistenceMapper mapper) {
    ...
    @Override
    public java.util.List<Campaign> findByStatus(com.autolift.campaign.domain.valueobject.CampaignStatus status) {
