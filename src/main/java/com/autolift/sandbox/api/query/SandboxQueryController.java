...
public class SandboxQueryController {
    ...
    public SandboxQueryController(GetSandboxQueryHandler getHandler,
                                 GetAllSandboxesQueryHandler getAllHandler) {
    ...
    public ResponseEntity<SandboxResponse> findById(@PathVariable String id) {
        return getHandler.handle(new GetSandboxQuery(id))
