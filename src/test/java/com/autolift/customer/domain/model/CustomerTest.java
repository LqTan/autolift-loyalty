...
class CustomerTest {
  ...
  void shouldCreateCustomer() {
    Customer customer = Customer.create("John Doe", "john@example.com", "0987654321", CustomerSegment.NORMAL);
  ...
  void shouldCreateCustomerWithVipSegment() {
    Customer customer = Customer.create("VIP Customer", "vip@example.com", "0987654321", CustomerSegment.VIP);
